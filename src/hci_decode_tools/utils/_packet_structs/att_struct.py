...
_ACL_ATT_PARAMS = {
    ...
    ATTProtocolCodes.ATT_EXCHANGE_MTU_REQ: [
        HciParam("Client_Rx_MTU", 2, hci_uint)
    ],
    ATTProtocolCodes.ATT_EXCHANGE_MTU_RSP: [
        HciParam("Server_Rx_MTU", 2, hci_uint)
    ],
    ATTProtocolCodes.ATT_FIND_INFORMATION_REQ: [
        HciParam("Starting_Handle", 2, hci_hexint),
        HciParam("Ending_Handle", 2, hci_hexint)
    ],
    ATTProtocolCodes.ATT_FIND_INFORMATION_RSP: [
        HciParam("Info", None, hci_att_info)
    ],
    ...
    ATTProtocolCodes.ATT_READ_REQ: [
        HciParam("Attribute_Handle", 2, hci_hexint)
    ],
    ATTProtocolCodes.ATT_READ_RSP: [
        HciParam("Attribute_Value", None, hci_hexint)
    ],
    ...
    ATTProtocolCodes.ATT_EXECUTE_WRITE_REQ: [
        HciParam("Execute", 1, hci_bool)
    ],
